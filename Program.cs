...
namespace In_class_10_Entity_Framework
{
    ...
    class OrderDetailsContext : DbContext
    {
        ...
        string connectionString = "Server=(localdb)\\MSSQLLocalDB;Database=Demo;Trusted_Connection=True;MultipleActiveResultSets=true";
    ...
    class Program
    {
        static void Main(string[] args)
        {
            using (OrderDetailsContext context = new OrderDetailsContext())
            {
                ...
                Order order1 = new Order { CustName = "Vivek" };
                Order order2 = new Order { CustName = "Kotha" };
